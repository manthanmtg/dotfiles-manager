...
# description: Comprehensive Kubernetes aliases — pods, deployments, services, logs, contexts, rollouts, and more.
# category: aliases
# icon: Container
# tags: kubernetes, devops, cloud, kubectl
# @end
...
alias kcsccn='kubectl config set-context --current --namespace'
...
alias krres='kubectl rollout resume'

# ─── Scale ───────────────────────────────────────────────────────────────────
alias ksc='kubectl scale'
alias kscr='kubectl scale --replicas'

# ─── Top (metrics) ──────────────────────────────────────────────────────────
alias ktpo='kubectl top pods'
alias ktno='kubectl top nodes'
alias ktsyspo='kubectl top pods --namespace=kube-system'
alias ktpoc='kubectl top pods --containers'

# ─── Edit / Patch / Diff ────────────────────────────────────────────────────
alias ke='kubectl edit'
alias kpa='kubectl patch'
...
alias ksysgrs='kubectl --namespace=kube-system get replicaset'
alias kdrs='kubectl describe replicaset'
alias krmrs='kubectl delete replicaset'
...
# ─── wide + --all-namespaces + --show-labels (all permutations) ─────────────
...
# ─── --all-namespaces + --show-labels + --watch (all permutations) ──────────
...
# ─── --namespace (explicit namespace arg) ───────────────────────────────────
...
# ─── --namespace + output format combos ──────────────────────────────────────
